...
<div id="admin_cnt">
	...
	<div id="index_cnt_right">
		<h1>Forum </h1>
		<div id="skill_img">
			<img src="images/forum.jpg" height="100px" width="300px"/>
		</div>
	...
	<div id="index_cnt_right">
	  <div id="exm_notice">
		<h1>Exam Notice</h1>
		<div id="skill_img">
			<img src="images/notice.jpg" height="100px" width="300px"/>
		</div>
		<p>Performance Builder provides a bunch of free online exams for candidates to evaluate themselves in .Net, C#, VB, Java, PHP, My SQL, SQL Server, Oracle, HTML, Java script, OOPS, C++, Windows , Linux and more.
		</p>
		</div>
	...
	<div id="index_cnt_mid">
		<h1>Give Exam</h1>
		<div id="skill_img">
			<img src="images/admin_exam2.jpg" height="100px" width="300px"/>
		</div>
